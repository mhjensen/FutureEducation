...
\paragraph{}
\begin{itemize}
\item Students  \textbf{pose and solve problems} that combine \textbf{physical insights} with \textbf{mathematical tools} and now also \textbf{computational skills}.

\item Essential for multi-disciplinary programs.
...
\href{run:mov-future/movtrimmed2.m4v}{\nolinkurl{mov-future/movtrimmed2.m4v}}
\end{center}
\end{doconce:movie}
